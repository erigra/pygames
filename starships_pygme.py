...
# Tegner opp spillvinduet for hver frame
def draw_window(red, yellow, red_bullets, yellow_bullets, red_health, yellow_health):
    WIN.blit(SPACE, (0,0))
    pygame.draw.rect(WIN, BLACK, BORDER)
    
    red_health_text = HEALTH_FONT.render("Score: " +str(red_health), 1, WHITE)
    yellow_health_text = HEALTH_FONT.render("Score: " +str(yellow_health), 1, WHITE)
